---
name: schejo
description: Route Schejo health report, daily reminder, and health-state requests for the paired iPhone app. Use when raw text mentions schejo, asks to generate/check today's health report, asks to set or send a daily report reminder, or reports short-term health state such as injuries, sickness, travel, busyness, or low motivation.
---
